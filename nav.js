...
const FOG_DAYS = [
  ...
  { num: 51, title: 'Rise, Take Up Your Bed',         available: true },
  { num: 52, title: 'Lazarus, Come Out',              available: true },
  { num: 53, title: 'The Temple Cleansed',            available: true },
  { num: 54, title: 'No One Ever Spoke Like This Man',available: true },
  { num: 55, title: 'Your Sins Are Forgiven',         available: true },
  { num: 56, title: 'The Good Shepherd',              available: true },
  { num: 57, title: 'The Vine and the Branches',      available: true },
  { num: 58, title: 'I and the Father Are One',       available: true },
  { num: 59, title: 'All Authority Is Given to Me',   available: true },
  { num: 60, title: 'The Bread of Life',              available: true },
  // Section V: The Lamb Who Was Slain (61–75)
  { num: 61, title: 'The Anointing at Bethany',       available: true },
  { num: 62, title: 'The Upper Room',                 available: true },
  { num: 63, title: 'Gethsemane',                     available: true },
  { num: 64, title: 'The Betrayal',                   available: true },
  { num: 65, title: 'Tried and Condemned',            available: true },
  { num: 66, title: 'The Via Dolorosa',               available: true },
  { num: 67, title: 'It Is Finished',                 available: true },
  { num: 68, title: 'The Darkness and the Curtain',   available: true },
  { num: 69, title: 'Buried in a Borrowed Tomb',      available: true },
  { num: 70, title: 'Why Seek the Living Among the Dead?', available: true },
  { num: 71, title: 'He Appeared to Mary',            available: true },
  { num: 72, title: 'The Road to Emmaus',             available: true },
  { num: 73, title: 'Doubting Thomas',                available: true },
  { num: 74, title: 'Breakfast on the Shore',         available: true },
  { num: 75, title: 'The Ascension',                  available: true },
  // Section VI: The Risen Lord (76–90)
  { num: 76, title: 'Seated at the Right Hand',       available: true },
  { num: 77, title: 'The Lamb in the Midst of the Throne', available: true },
  { num: 78, title: 'Our Advocate',                   available: true },
  { num: 79, title: 'A Priest Forever',               available: true },
  { num: 80, title: 'Union with Christ',              available: true },
  { num: 81, title: 'Christ in You, the Hope of Glory', available: true },
  { num: 82, title: 'To Know Him',                    available: true },
  { num: 83, title: 'Nothing Can Separate Us',        available: true },
  { num: 84, title: 'He Is Able to Save Completely',  available: true },
  { num: 85, title: 'Beholding as in a Mirror',       available: true },
  { num: 86, title: 'He Who Calls You Is Faithful',   available: true },
  { num: 87, title: 'Come, Lord Jesus',               available: true },
  { num: 88, title: 'The Love That Will Not Let Go',  available: true },
  { num: 89, title: 'He Makes All Things New',        available: true },
  { num: 90, title: 'Alpha and Omega',                available: true },
];
