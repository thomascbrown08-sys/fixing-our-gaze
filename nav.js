...
const FOG_DAYS = [
  ...
  { num: 21, title: 'He Touched the Leper',           available: false },
  { num: 22, title: 'The One Who Wept',               available: false },
  { num: 23, title: 'The Compassion of the King',     available: false },
  { num: 24, title: 'No Room in the Inn',             available: false },
  { num: 25, title: 'The Son of Man',                 available: false },
  { num: 26, title: 'Homeless in His Own World',      available: false },
  { num: 27, title: 'He Came to Seek and Save',       available: false },
  { num: 28, title: 'The Great Physician',            available: false },
  { num: 29, title: 'Lord of the Sabbath',            available: false },
  { num: 30, title: 'He Who Humbled Himself',         available: false },
  // Section III: Words of Life (31–45)
  { num: 31, title: 'The Sermon Begins',              available: false },
  { num: 32, title: 'Blessed Are the Poor in Spirit', available: false },
  { num: 33, title: "The Lord's Prayer",              available: false },
  { num: 34, title: 'The Prodigal and His Father',    available: false },
  { num: 35, title: 'The Good Samaritan',             available: false },
  { num: 36, title: 'The Lost Sheep',                 available: false },
  { num: 37, title: 'The Pearl of Great Price',       available: false },
  { num: 38, title: 'The Sower and the Soil',         available: false },
  { num: 39, title: 'The Mustard Seed',               available: false },
  { num: 40, title: 'New Wine, New Wineskins',        available: false },
  { num: 41, title: 'The Pharisee and the Tax Collector', available: false },
  { num: 42, title: 'Unless You Become Like a Child', available: false },
  { num: 43, title: 'The Narrow Door',                available: false },
  { num: 44, title: 'The Rich Young Ruler',           available: false },
  { num: 45, title: 'Come to Me, All Who Are Weary',  available: false },
  // Section IV: The Authority of the King (46–60)
  { num: 46, title: 'He Taught as One with Authority',available: false },
  { num: 47, title: 'Peace, Be Still',                available: false },
  { num: 48, title: 'Who Then Is This?',              available: false },
  { num: 49, title: 'The Keys of the Kingdom',        available: false },
  { num: 50, title: 'He Rebuked the Unclean Spirit',  available: false },
